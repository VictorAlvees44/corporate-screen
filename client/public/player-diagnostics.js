...
(function (root) {
  ...
  root.CorporateScreenDiagnostics = {
    ...
    create: function () {
      var state = { version: '2026-09-04.3', state: 'loading', playlistId: '', itemId: '', mediaName: '', receivedSync: '', offline: false, errorCode: '', diagnostics: { checkedRequest: '', capabilities: capabilities(), network: { samples: 0, lastMs: 0, averageMs: 0, failures: 0, networkFailures: 0, consecutiveFailures: 0, lastHttpStatus: 0 }, media: { loadMs: null, stalls: 0 }, power: power() } };
      var samples = [];
      var errorSequence = 0;
